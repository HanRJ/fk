            ...
            <div class="main">
                <div class="mod_detail">
                    <div class="detail_collect">
                        ...
                        <?php if($_total == 0 ): ?><div class="mod_empty">
                                <div class="ico_warn"></div>
                                <p class="tip_cnt">当前收藏为空，您可以逛逛热门主题哈！</p>
                        ...
                        <table class="mod_table">
                            ...
                            <tr>
                                ...
                                <th class="col_publisher">发布者</th>
                                <th class="col_date">收藏日期</th>
                            ...
                            <tbody>
                            <?php if(is_array($collects)): foreach($collects as $key=>$citem): ?><tr data-tid="<?php echo ($citem["topic_id"]); ?>" data-cid="<?php echo ($citem["id"]); ?>" data-goldprice="<?php echo ((isset($citem["gold_price"]) && ($citem["gold_price"] !== ""))?($citem["gold_price"]):0); ?>" class="topic_tr">
                                    <td>
                                        <p><a href="<?php echo U('Topic/index', array(id=>$citem['topic_id']));?>" target="_blank"><?php echo ($citem["title"]); ?></a></p>
                                    </td>
                                    <td><?php echo ((isset($citem["author_nick"]) && ($citem["author_nick"] !== ""))?($citem["author_nick"]):'炼金大师'); ?></td>
                                    <td><?php echo (date('Y-m-d',$citem["add_time"])); ?></td>
                                    <td>1万元 <span class="rate">（<strong>/58%</strong>）</span></td>
                                    <td>6万人</td>
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn_gray_2">加入购物车</a>
                                        <a href="javascript:void(0)" class="btn btn_red">买入</a>
                                        <a href="javascript:void(0)" class="btn btn_delete">卖出</a>
                                    </td>
...
<script type="text/javascript" src="/runmoney/Public/V1/js/common/util.js"></script>
    ...
    <script type="text/javascript" src="/runmoney/Public/V1/js/center/collect.js"></script>
</body>
</html>