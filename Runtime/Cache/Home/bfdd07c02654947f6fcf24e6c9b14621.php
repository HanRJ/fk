            ...
            <div class="main">
                <div class="mod_detail mod_overview">
                    ...
                    <div class="detail_invest">
                        <div class="mod_title">
                            <h3>投资管理</h3>
                            <span class="update_date">更新时间：<?php echo date("Y.m.d");?></span>
                        </div>
                        <table class="mod_table">
                            ...
                            <tr>
                                <td>
                                    <p><a href="<?php echo U('Topic/index', array(id=>1));?>" target="_blank">体育强国</a></p>
                            ...
                            <tr>
                                <td>
                                    <p><a href="<?php echo U('Topic/index', array(id=>2));?>" target="_blank">体育强国</a></p>
                                    <p class="expert">（专家小李）</p>
                                </td>
                                <td>20000</td>
                                <td>2104-11-02</td>
                            ...
                            <tr>
                                <td>
                                    <p><a href="<?php echo U('Topic/index', array(id=>3));?>" target="_blank">体育强国</a></p>
                                    <p class="expert">（专家小李）</p>
                                </td>
                                <td>20000</td>
                                <td>2104-11-02</td>
                    ...
                    <div class="detail_theme">
                        <div class="mod_title">
                            <h3>我发布的主题</h3>
                            <a href="<?php echo U('Topic/create');?>" class="btn_add">新建主题</a>
                        </div>
                        <table class="mod_table">
                            <thead>
                            <tr>
                            ...
                            <tbody>
                            <?php if(count($topics) == 0 ): ?><td colspan="6">尚未发布主题！</td><?php endif; ?>
                            <?php if(is_array($topics)): foreach($topics as $key=>$topic): ?><tr data-tid="<?php echo ($topic["id"]); ?>" class="topic_tr">
                                    <td>
                                        <p><a href="<?php echo U('Topic/index', array(id=>$topic['id']));?>" target="_blank"><?php echo ($topic["title"]); ?></a></p>
                                    </td>
                                    <td><?php echo (date('Y-m-d',$topic["create_time"])); ?></td>
                                    <td>1万元</td>
                                    <td>6万人</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn_red">买入</a>
                                        <a href="#" class="btn btn_gray_2">卖出</a>
                                        <a href="#" class="btn btn_delete">删除</a>
                                    </td>
...
<script type="text/javascript" src="/runmoney/Public/V1/js/common/util.js"></script>
    ...
    <script type="text/javascript" src="/runmoney/Public/V1/js/center/index.js"></script>
