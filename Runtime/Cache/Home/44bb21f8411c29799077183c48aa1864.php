            ...
            <div class="main">
                <div class="mod_detail">
                    <div class="detail_cart">
                        ...
                        <?php if(count($carts) == 0 ): ?><div class="mod_empty">
                                <div class="ico_warn"></div>
                                <p class="tip_cnt">购物车为空，您可以逛逛热门主题哈！</p>
                                <p><a href="<?php echo U('Topic/list');?>" class="btn btn_red">去看看</a></p>
                            </div>
                        <?php else: ?>
                        <table class="mod_table">
                            <thead>
                            <tr>
                                <th class="col_select"><label><input class="cb_all" type="checkbox"/> <span>全选</span></label></th>
                                <th class="col_theme">主题策略（股票） </th>
                                <th class="col_price">价格</th>
                                <th class="col_date">加入日期</th>
                                <th class="col_profit">收益率</th>
                                <th class="col_hot">跟投人气</th>
                                <th class="col_handle">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($carts)): foreach($carts as $key=>$citem): ?><tr data-tid="<?php echo ($citem["topic_id"]); ?>" data-cid="<?php echo ($citem["id"]); ?>" data-goldprice="<?php echo ((isset($citem["gold_price"]) && ($citem["gold_price"] !== ""))?($citem["gold_price"]):0); ?>" class="topic_tr">
                                    <td><input type="checkbox"/></td>
                                    <td>
                                        <p><a href="<?php echo U('Topic/index', array(id=>$citem['topic_id']));?>" target="_blank"><?php echo ($citem["title"]); ?></a></p>
                                        <p class="expert">（<?php echo ((isset($citem["author_nick"]) && ($citem["author_nick"] !== ""))?($citem["author_nick"]):'炼金大师'); ?>）</p>
                                    </td>
                                    <td><?php echo ((isset($citem["gold_price"]) && ($citem["gold_price"] !== ""))?($citem["gold_price"]):0); ?>金币</td>
                                    <td><?php echo (date('Y-m-d',$citem["add_time"])); ?></td>
                                    <td>
                                        <p class="rate"><strong>58%</strong></p>
                                    </td>
                                    <td>2万人</td>
                                    <td>
                                        <p><a href="#" class="topic_remove">移入收藏</a></p>
                                        <p><a href="#" class="topic_delete">删除</a></p>
                                    </td>
                                </tr><?php endforeach; endif; ?>
                            </tbody>
                            <tfoot>
                            <tr>
                                <td><label><input class="cb_all" type="checkbox"/> <span>全选</span></label></td>
                                <td colspan="2">
                                    <a href="#" class="link_op topic_remove_select">移入收藏</a>
                                    <a href="#" class="link_op topic_delete_select">删除</a>
                                </td>
                                <td colspan="4" class="sum">
                                    已选主题 <span class="num">0</span>
                                    价格： <span class="price">￥0.00</span>
                                    <!--<a href="##" class="btn btn_red">提交订单</a>-->
                                    <span class="btn btn_disabled">提交订单</span>
                                </td>
                            </tr>
                            </tfoot>
                        </table><?php endif; ?>
...
<script type="text/javascript" src="/runmoney/Public/V1/js/common/util.js"></script>
    ...
    <script type="text/javascript" src="/runmoney/Public/V1/js/center/cart.js"></script>
