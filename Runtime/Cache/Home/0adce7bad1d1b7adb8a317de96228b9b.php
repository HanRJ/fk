                ...
                <div class="mod_detail">
                    <div class="detail_theme">
                        <?php if($_total == 0 ): ?><div class="mod_empty">
                                ...
                                <p class="tip_cnt">还没有创建任何主题？您可以逛逛热门主题哈！</p>
                                <p><a href="<?php echo U('Topic/list');?>" class="btn btn_red">去看看</a> <a href="<?php echo U('Topic/create');?>" class="btn btn_red">新建主题</a></p>
                            </div>
                        <?php else: ?>
                        <div class="mod_title">
                            <h3>我发布的主题</h3>
...
<script type="text/javascript" src="/runmoney/Public/V1/js/common/util.js"></script>
    ...
    <script type="text/javascript" src="/runmoney/Public/V1/js/center/theme.js"></script>
