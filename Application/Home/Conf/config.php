 ...
 */
return array(
    'HOME_LIST_ROWS' => 10, // 分页条目数
    'URL_MODEL'      => 2,  // URL模式

    // TODO: 路由规则
    'URL_ROUTER_ON'   => true,
    'URL_ROUTE_RULES' => array(
        '/^topic\/(\d+)$/' => 'Topic/Index?id=:1',
        '/^Topic\/list$/' => 'Topic/listAction'
    ),
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'runmoney_home', //session前缀
    'COOKIE_PREFIX'  => 'runmoney_home_', // Cookie前缀 避免冲突
